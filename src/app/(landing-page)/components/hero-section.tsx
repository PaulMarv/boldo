...
export default function HeroSection() {
    return (
        <section className='w-full relative lg:pt-[144px] pt-[100px] overflow-clip'>
            <div className="hidden lg:block absolute top-[-160%] right-[-50%] w-[1393px] h-[1393px] rounded-full bg-[#F1F1F1]"></div>
            <Wrapper className='z-[10]'>
                <div className='flex lg:flex-row flex-col items-center justify-between'>
                    <div className='w-full lg:max-w-[601px]'>
                        ...
                        <div className='flex flex-col lg:flex-row gap-6 mt-[49px]'>
